...
public class AdminShowPromotionsCommand implements ProcessableCommand {
    ...
    public AdminShowPromotionsCommand(List<Promotion> promotions) {
        ...
        row1.add(CommandType.CREATE_PROMOTION.getName());
        row2.add(CommandType.UPDATE_PROMOTION.getName());
        row3.add(CommandType.DELETE_PROMOTION.getName());
    ...
    public AdminShowPromotionsCommand() {
        ...
        row1.add(CommandType.CREATE_PROMOTION.getName());
        row2.add(CommandType.HOME.getName());
